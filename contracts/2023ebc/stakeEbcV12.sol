...
contract StakeEbcV12 is Initializable,OwnableUpgradeable {
 ...
 event ceshi(uint256 indexed beishu, uint256 indexed ymii, uint256 base);
    ...
    function getInvitationsFromIndex(uint256 startIndex) external view returns (address[] memory invitees, address[] memory inviters, uint256[] memory userStakesA, uint256[] memory userStakesB, uint256[] memory userStakeStartTime) {
